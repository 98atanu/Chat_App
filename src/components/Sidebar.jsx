...
const Sidebar = () => {
    return (
        <div className='bg-[#d12a5c] shadow-lg shadow-[#262626] w-[40vw] h-screen pr-0.5'>
            ...
            <div className='bg-[#871b3b] h-full mt-1  '>
                <div className='ml-3 mr-3'>
                    ...
                    <div className=' flex justify-between h-full bg-[#262626] px-3 py-2 rounded-md gap-6'>
